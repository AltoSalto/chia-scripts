...
"Final directory:"
$destinationPath
"Number of concurrent plot processes:"
$instanceCount
"Delay between plots:"
$delayMin
...
"Number of threads"
$numThreads
"Number of cycles per process"
$numberOfCyclePerProcessus
"Log folder"
$logFolder = ".\Log\"
<#
...
#$delaySec = $delayMin * 20 # Delay between start of process.  This delays the plotting process
